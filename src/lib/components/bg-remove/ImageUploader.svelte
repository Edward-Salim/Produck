...
<button
  type="button"
  class="relative flex h-full w-full cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-cork-300 p-8 transition-colors hover:border-cork-400 {dragOver
    ? 'border-cork-400 bg-cork-200/50'
    : ''}"
  ondrop={handleDrop}
...
>
  {#if preview}
    <img src={preview} alt="Upload preview" class="h-32 w-32 rounded-lg object-cover" />
    <span
